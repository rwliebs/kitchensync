      ...
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          <div className="flex items-center space-x-3 mb-2">
            ...
            <div>
              <h4 className="font-medium text-gray-900">{task.recipeName}</h4>
          ...
          <div className="flex items-center space-x-4 text-sm text-gray-600">
            ...
            {timeRemaining !== null && timeRemaining > 0 && !isCompleted && (
              <div className={`flex items-center ${isCurrent || isActive ? 'text-orange-600 font-medium' : ''}`}>
        ...
        {/* Action Button */}
        {!isCompleted && onComplete && (isCurrent || isActive) && (
          <button
